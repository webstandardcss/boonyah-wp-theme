...
<!-- Main Contents Starts -->
    ...
    <!-- Contents Starts -->
    	...
    	<h3>BoonYah media kit</h3>
        <p>The following are the official BoonYah logos and screenshots for press and promotional purposes. If you can’t find an image that you’re looking for contact us.</p>
        ...
        <h3>Asset Usage</h3>
        <p>BoonYah’s assets can only be used for material relating to BoonYah. Modifying or editing our assets in any way is strictly prohibited.  Only the images available for download on this page should be used. Do not use unofficial assets.</p>

        <div class="row">
        	<article class="col-sm-6 list dont">
        		<h4>Do Not:</h4>
        		<ul class="list-unstyled">
        			<li>Modify or alter the BoonYah logo or screenshots in any way.</li>
        			<li>Combine the BoonYah assets with any other name or logo.</li>
        			<li>Use the BoonYah logo in reference to any service other than BoonYah.</li>
        			<li>Use any version of the BoonYah assets that are not currently on our site.</li>
        		</ul>
        	</article>

        	<article class="col-sm-6 list do">
        		<h4>Do:</h4>
        		<ul class="list-unstyled">
        			<li>Leave enough space around the BoonYah logo so it doesn’t become cluttered.</li>
        			<li>Add the BoonYah assets to your materials in a tasteful manner.</li>
        			<li>Visit this page regularly for updated material</li>
        		</ul>
        	</article>
        </div>
